...
# Usage : ./deploy.sh
# Lance tout le projet depuis zéro en posant juste 2 questions
...
# ── Mettre à jour le secret GitHub K8S_MASTER_HOST ────────────────
echo ""
echo "⚠️  N'oubliez pas de mettre à jour le secret GitHub :"
echo "   K8S_MASTER_HOST = ${MASTER_IP}"
echo "   STAGING_HOST    = ${STAGING_IP}"
echo ""
read -p "Appuyez sur Entrée pour continuer le déploiement..."

# ── Ajouter les clés SSH connues ───────────────────────────────────
echo ""
